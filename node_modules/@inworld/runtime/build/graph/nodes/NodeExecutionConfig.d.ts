 ...
 */
export interface NodeExecutionConfigInterface {
    /**
 ...
 */
export declare class NodeExecutionConfig implements NodeExecutionConfigInterface {
    reportToClient?: boolean;
    constructor(props?: NodeExecutionConfigInterface);
    /**
     * @internal
     */
    getExternal(): void;
 ...
 */
export interface STTNodeExecutionConfigPropsInterface extends NodeExecutionConfig {
    /**
 ...
 */
export interface TTSNodeExecutionConfigPropsInterface extends NodeExecutionConfig {
    /**
     * The speaker ID.
     */
    speakerId: string;
 ...
 */
export interface IntentNodeExecutionConfigPropsInterface extends NodeExecutionConfig {
    /**
     * The matcher config.
     */
 ...
 */
export interface LLMChatNodeExecutionConfigPropsInterface extends NodeExecutionConfig {
    /**
 ...
 */
export interface TextAggregatorNodeExecutionConfigPropsInterface extends NodeExecutionConfig {
}
/**
 * Represents the properties for the text chunking node execution config.
 */
export interface TextChunkingNodeExecutionConfigPropsInterface extends NodeExecutionConfig {
}
/**
...
export declare class ExecutionConfig {
     ...
     */
    constructor(external: ExternalReference, props: NodeExecutionConfig);
    /**
     * Constructs a new execution config.
     *
     * @param external - The external reference.
