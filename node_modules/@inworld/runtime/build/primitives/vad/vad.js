...
class VAD {
     ...
     */
    async detectVoiceActivity(audio, speechThreshold) {
        let audioChunk = null;
        let vadConfig = null;
        ...
        try {
            ...
            detectionStatus = await expose_binary_1.VADInterfaceFunctions.detectVoiceActivity(this.vad, audioChunk.getExternal(), vadConfig.getExternal());
