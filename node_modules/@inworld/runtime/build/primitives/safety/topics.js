...
class Topic {
    ...
    getType() {
        ...
        if (topicName === undefined) {
            throw new inworld_1.InworldError('Invalid topic name', { topicName: topicId });
        }
        return topicName;
    }
    /**
    ...
    static getTopicId(topicName) {
        ...
        if (topicId === undefined) {
            throw new inworld_1.InworldError('Invalid topic name', { topicName });
        }
        return topicId;
    }
    getExternal() {
...
class DetectedTopic extends Topic {
    constructor(...args) {
        if (args.length === 2) {
            ...
            throw new inworld_1.InworldError('DetectedTopic: Invalid arguments');
        }
    }
}
