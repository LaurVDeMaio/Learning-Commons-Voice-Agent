 ...
 * @internal
 */
export declare class VectorString {
    private external;
    /**
     ...
     */
    static toArray(external: ExternalReference): string[];
}
