import { AudioChunkInterface, ExternalReference } from '../common';
...
export declare class AudioData extends BaseData {
     ...
     */
    static fromExternal(external: ExternalReference): AudioData;
}
