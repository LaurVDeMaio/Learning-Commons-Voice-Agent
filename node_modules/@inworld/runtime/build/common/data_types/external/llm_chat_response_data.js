...
exports.LLMChatResponseData = void 0;
 ...
 */
class LLMChatResponseData extends base_data_1.BaseData {
    /**
     * @internal
     ...
     * @returns {LLMChatResponseData | null} A new LLMChatResponse instance or null if invalid
     */
    static fromExternal(external) {
        ...
        if (baseData && expose_binary_1.LLMChatResponseFunctions.isValid(baseData)) {
            return new LLMChatResponseData(baseData);
        }
        return null;
    }
    /**
...
exports.LLMChatResponseData = LLMChatResponseData;
