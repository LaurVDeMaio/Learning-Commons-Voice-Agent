...
[](/classes)
  ...
  * [common/data_types/external/memory_state_data](/modules/common_data_types_external_memory_state_data)
  * [MemoryStateData]()
...
The memory state, or undefined if no memory state is found
