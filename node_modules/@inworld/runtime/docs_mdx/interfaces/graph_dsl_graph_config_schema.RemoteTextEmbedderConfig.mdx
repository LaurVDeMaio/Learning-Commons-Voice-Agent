...
# Interface RemoteTextEmbedderConfig

Configuration for remote text embedder

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "RemoteTextEmbedderConfig".
