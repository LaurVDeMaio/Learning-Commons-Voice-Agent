...
[](/interfaces)
  ...
  * [RemoteTTSConfigInterface]()



# Interface RemoteTTSConfigInterface

Interface for configuring remote TTS (Text-to-Speech) instances.

interface RemoteTTSConfigInterface {  
apiKey: string;  
synthesisConfig?: [SpeechSynthesisConfigInterface](./primitives_tts_config.SpeechSynthesisConfigInterface);  
}
