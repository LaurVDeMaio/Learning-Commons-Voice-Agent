...
# Interface IntentEmbedderMatchNodeExecutionConfig

Configuration for executing intent embedder match nodes

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "IntentEmbedderMatchNodeExecutionConfig".
...
report_to_client? similarity_threshold?
...
report_to_clientsimilarity_threshold
