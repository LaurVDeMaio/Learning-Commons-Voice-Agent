...
# Interface NERCreationConfig

Configuration for creating NER

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "NERCreationConfig".

interface NERCreationConfig {  
entities: [Entity](./graph_dsl_graph_config_schema.Entity)[];  
}
