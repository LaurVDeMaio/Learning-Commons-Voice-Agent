...
# Interface GoalAdvancementNodeCreationConfig

Configuration for creating goal advancement nodes

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "GoalAdvancementNodeCreationConfig".

interface GoalAdvancementNodeCreationConfig {  
goals: [Goal](./graph_dsl_graph_config_schema.Goal)[];  
}
