...
# Interface MCPCallToolNodeExecutionConfig

Configuration for executing MCP call tool nodes

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "MCPCallToolNodeExecutionConfig".
