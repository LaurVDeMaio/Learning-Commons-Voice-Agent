...
# Interface MemoryUpdateNodeCreationConfig

Configuration for executing memory update nodes

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "MemoryUpdateNodeCreationConfig".
