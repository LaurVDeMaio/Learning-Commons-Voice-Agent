...
# Interface LocalTextEmbedderConfig

Configuration for local text embedder

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "LocalTextEmbedderConfig".
