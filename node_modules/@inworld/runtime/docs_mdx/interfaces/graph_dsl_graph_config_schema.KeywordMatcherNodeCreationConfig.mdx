...
# Interface KeywordMatcherNodeCreationConfig

Configuration for creating keyword matcher nodes

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "KeywordMatcherNodeCreationConfig".

interface KeywordMatcherNodeCreationConfig {  
keyword_groups: [KeywordGroup](./graph_dsl_graph_config_schema.KeywordGroup)[];  
}
