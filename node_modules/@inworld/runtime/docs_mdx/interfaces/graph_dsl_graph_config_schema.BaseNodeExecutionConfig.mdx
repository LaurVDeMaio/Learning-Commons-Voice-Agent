...
# Interface BaseNodeExecutionConfig

Base configuration for node execution

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "BaseNodeExecutionConfig".
