...
# Interface VoiceActivityDetectionConfig

Configuration for voice activity detection

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "VoiceActivityDetectionConfig".

interface VoiceActivityDetectionConfig {  
speech_threshold?: string | number;  
}
