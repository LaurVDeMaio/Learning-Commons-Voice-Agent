...
interface MainGraph {  
edges?: [Edge](./graph_dsl_graph_config_schema.Edge)[];  
end_nodes?: string[];  
id: string;  
nodes?: [Node](/types/graph_dsl_graph_config_schema.Node)[];  
...
edges? end_nodes? id nodes? start_nodes?
...
edgesend_nodesidnodesstart_nodes
