...
# Interface RandomCannedTextNodeExecutionConfig

Configuration for executing random canned text nodes

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "RandomCannedTextNodeExecutionConfig".
...
canned_phrases report_to_client?
...
canned_phrasesreport_to_client
