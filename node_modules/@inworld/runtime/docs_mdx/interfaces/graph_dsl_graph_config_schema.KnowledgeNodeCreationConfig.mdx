...
# Interface KnowledgeNodeCreationConfig

Configuration for creating knowledge nodes

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "KnowledgeNodeCreationConfig".
...
knowledge_component_id knowledge_id
...
knowledge_component_idknowledge_id
