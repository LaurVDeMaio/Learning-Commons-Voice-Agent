...
# Interface InworldSpeechSynthesisConfig

Configuration for Inworld speech synthesis

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "InworldSpeechSynthesisConfig".
