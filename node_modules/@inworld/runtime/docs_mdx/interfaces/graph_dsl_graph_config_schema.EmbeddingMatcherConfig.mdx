...
# Interface EmbeddingMatcherConfig

Configuration for embedding-based intent matching

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "EmbeddingMatcherConfig".
