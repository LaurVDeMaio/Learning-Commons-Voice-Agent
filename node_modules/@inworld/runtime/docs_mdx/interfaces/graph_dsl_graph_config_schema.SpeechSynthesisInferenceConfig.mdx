...
# Interface SpeechSynthesisInferenceConfig

Configuration for model inference parameters in TTS

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "SpeechSynthesisInferenceConfig".
