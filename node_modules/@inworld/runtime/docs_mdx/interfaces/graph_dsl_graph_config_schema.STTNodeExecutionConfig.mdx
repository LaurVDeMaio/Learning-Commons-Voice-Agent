...
# Interface STTNodeExecutionConfig

Configuration for executing STT nodes

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "STTNodeExecutionConfig".
...
report_to_client? stt_component_id
...
report_to_clientstt_component_id
