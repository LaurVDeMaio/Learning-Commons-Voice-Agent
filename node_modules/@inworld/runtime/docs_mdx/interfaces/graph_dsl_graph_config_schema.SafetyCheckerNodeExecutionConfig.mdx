...
# Interface SafetyCheckerNodeExecutionConfig

Configuration for executing safety checker nodes

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "SafetyCheckerNodeExecutionConfig".

interface SafetyCheckerNodeExecutionConfig {  
report_to_client?: string | boolean;  
safety_config?: { [k: string]: unknown };  
}
...
report_to_client? safety_config?
