...
# Interface TTSNodeExecutionConfig

Configuration for executing TTS nodes

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "TTSNodeExecutionConfig".
...
report_to_client? tts_component_id
...
report_to_clienttts_component_id
