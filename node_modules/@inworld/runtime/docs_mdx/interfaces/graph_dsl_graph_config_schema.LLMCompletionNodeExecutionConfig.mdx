...
# Interface LLMCompletionNodeExecutionConfig

Configuration for executing LLM completion nodes

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "LLMCompletionNodeExecutionConfig".
