...
This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "TextClassifierConfig".

interface TextClassifierConfig {  
classes: [ClassThreshold](./graph_dsl_graph_config_schema.ClassThreshold)[];  
}
