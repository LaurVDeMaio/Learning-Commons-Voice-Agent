...
# Interface MCPListToolsNodeExecutionConfig

Configuration for executing MCP list tools nodes

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "MCPListToolsNodeExecutionConfig".

interface MCPListToolsNodeExecutionConfig {  
mcp_component_id: string;  
...
mcp_component_id report_to_client?
...
mcp_component_idreport_to_client
