...
# Interface KnowledgeNodeExecutionConfig

Configuration for executing knowledge nodes

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "KnowledgeNodeExecutionConfig".
...
knowledge_ids report_to_client?
