...
# Interface IntentNodeExecutionConfig

Configuration for executing intent nodes

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "IntentNodeExecutionConfig".
