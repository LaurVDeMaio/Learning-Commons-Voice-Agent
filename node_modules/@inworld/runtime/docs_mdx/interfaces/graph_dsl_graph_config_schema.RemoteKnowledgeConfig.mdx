...
# Interface RemoteKnowledgeConfig

Configuration for remote knowledge

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "RemoteKnowledgeConfig".
