...
# Interface GoalAdvancementNodeExecutionConfig

Configuration for executing goal advancement nodes

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "GoalAdvancementNodeExecutionConfig".
...
llm_component_id report_to_client?
...
llm_component_idreport_to_client
