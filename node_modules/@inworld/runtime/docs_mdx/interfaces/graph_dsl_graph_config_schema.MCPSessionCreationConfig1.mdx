...
[](/interfaces)
  ...
  * [MCPSessionCreationConfig1]()



# Interface MCPSessionCreationConfig1

Configuration for creating MCP session

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "MCPSessionCreationConfig".
