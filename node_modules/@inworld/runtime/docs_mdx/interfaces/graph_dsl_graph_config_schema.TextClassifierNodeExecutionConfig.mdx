...
# Interface TextClassifierNodeExecutionConfig

Configuration for executing text classifier nodes

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "TextClassifierNodeExecutionConfig".
