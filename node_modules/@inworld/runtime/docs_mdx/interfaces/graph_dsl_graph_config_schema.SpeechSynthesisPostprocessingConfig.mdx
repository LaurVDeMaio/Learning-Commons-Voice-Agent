...
# Interface SpeechSynthesisPostprocessingConfig

Configuration for postprocessing the generated speech waveform

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "SpeechSynthesisPostprocessingConfig".
