...
# Interface MCPClientCreationConfig

Configuration for creating MCP client

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "MCPClientCreationConfig".
