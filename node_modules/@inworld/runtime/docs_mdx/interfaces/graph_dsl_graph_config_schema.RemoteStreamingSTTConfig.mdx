...
# Interface RemoteStreamingSTTConfig

Configuration for remote streaming STT

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "RemoteStreamingSTTConfig".
