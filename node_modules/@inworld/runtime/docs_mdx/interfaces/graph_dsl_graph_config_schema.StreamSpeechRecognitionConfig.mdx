...
# Interface StreamSpeechRecognitionConfig

Configuration for streaming speech recognition

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "StreamSpeechRecognitionConfig".

interface StreamSpeechRecognitionConfig {  
silence_threshold_ms?: string | number;  
}
