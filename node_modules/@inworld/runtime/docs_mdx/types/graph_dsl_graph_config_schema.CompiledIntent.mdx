...
# Type Alias CompiledIntent

CompiledIntent: [Intent](/interfaces/graph_dsl_graph_config_schema.Intent) & {  
...
This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "CompiledIntent".

#### Type declaration

  * ##### `Optional`normalized_phrases?: string[]

Normalized training phrases

  * ##### `Optional`phrase_embeddings?: number[][]
