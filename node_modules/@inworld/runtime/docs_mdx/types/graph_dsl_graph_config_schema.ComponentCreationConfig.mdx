...
# Type Alias ComponentCreationConfig

ComponentCreationConfig: { [k: string]: unknown } & {  
...
This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "ComponentCreationConfig".
