...
# Type Alias MCPAuthConfig1

MCPAuthConfig1: { [k: string]: unknown }

Authentication configuration for MCP

This interface was referenced by `InworldBasicConfigurationSchema`'s JSON-Schema via the `definition` "MCPAuthConfig".
