...
class Device {
    ...
    getType() {
        switch (expose_binary_1.DeviceFunctions.getDeviceType(this.external)) {
            ...
            default:
                throw new inworld_1.InworldError('Invalid device type', {
     ...
     */
    getIndex() {
        return expose_binary_1.DeviceFunctions.getDeviceIndex(this.external);
    }
    /**
     ...
     */
    getInfo() {
        const info = expose_binary_1.DeviceFunctions.getDeviceInfo(this.external);
        return {
            name: expose_binary_1.DeviceFunctions.getDeviceInfoName(info),
            freeMemoryBytes: expose_binary_1.DeviceFunctions.getDeviceInfoFreeMemoryBytes(info),
            totalMemoryBytes: expose_binary_1.DeviceFunctions.getDeviceInfoTotalMemoryBytes(info),
        };
    }
    /**
