 ...
 */
export declare class MatchedIntents {
    /**
     * @internal
     */
    private external;
     ...
     */
    static fromExternal(external: ExternalReference): MatchedIntents;
    /**
     * Retrieves the matches.
     *
     * @returns {any[] | undefined} An array of intent matches, or undefined if no matches are found
     */
    getMatchers(): import("../vector/intent_match").IntentMatchInterface[];
}
