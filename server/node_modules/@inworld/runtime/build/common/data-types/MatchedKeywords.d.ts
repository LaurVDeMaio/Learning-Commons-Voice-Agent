 ...
 */
export declare class MatchedKeywords {
    /**
     * @internal
     */
    private external;
     ...
     *
     * @param {ExternalReference} external - The external reference to create the instance from
     * @returns {MatchedKeywords} A new MatchedKeywords instance
     */
    static fromExternal(external: ExternalReference): MatchedKeywords;
    /**
     * Retrieves the matches.
     *
     * @returns {any[] | undefined} An array of keyword matches, or undefined if no matches are found
     */
    getMatchers(): import("../vector/keyword_match").KeywordMatchInterface[];
}
