...
import { KnowledgeNode, LLMChatNode, LLMCompletionNode, STTNode, TextChunkingNode, TTSNode } from './builtin';
import { IntentNode } from './builtin/IntentNode';
import { TextAggregatorNode } from './builtin/TextAggregatorNode';
import { IntentNodeExecutionConfigPropsInterface, LLMChatNodeExecutionConfigPropsInterface, STTNodeExecutionConfigPropsInterface, TextAggregatorNodeExecutionConfigPropsInterface, TextChunkingNodeExecutionConfigPropsInterface, TTSNodeExecutionConfigPropsInterface } from './NodeExecutionConfig';
/**
 ...
 */
export interface LLMChatNodeFactoryInterface extends NodeFactoryInterface {
    ...
    executionConfig: LLMChatNodeExecutionConfigPropsInterface;
    /** Whether to stream the results (default: false) */
    stream?: boolean;
}
/**
 * Interface for LLM Completion node factory parameters.
 */
export interface LLMCompletionNodeFactoryInterface extends NodeFactoryInterface {
    /** Configuration for the LLM (local or remote) */
    llmConfig: RemoteLLMConfigInterface | LocalLLMConfigInterface;
    /** Execution configuration for the LLM completion node */
    executionConfig: LLMChatNodeExecutionConfigPropsInterface;
    /** Whether to stream the results (default: false) */
    stream?: boolean;
}
...
export interface TTSNodeFactoryInterface extends NodeFactoryInterface {
    ...
    ttsConfig: RemoteTTSConfigInterface;
...
export interface TextChunkingNodeFactoryInterface extends NodeFactoryInterface {
    /** Optional execution configuration for the text chunking node */
    executionConfig?: TextChunkingNodeExecutionConfigPropsInterface;
}
/**
...
export interface TextAggregatorNodeFactoryInterface extends NodeFactoryInterface {
    ...
    executionConfig?: TextAggregatorNodeExecutionConfigPropsInterface;
}
/**
...
export declare class NodeFactory {
     ...
     */
    static createRemoteLLMNode(props: LLMChatNodeFactoryInterface): Promise<LLMChatNode>;
    /**
     ...
     * @returns Promise resolving to a new LLM node
     */
    static createLocalLLMNode(props: LLMChatNodeFactoryInterface): Promise<LLMChatNode>;
    /**
     ...
     */
    static createRemoteLLMCompletionNode(props: LLMCompletionNodeFactoryInterface): Promise<LLMCompletionNode>;
    /**
