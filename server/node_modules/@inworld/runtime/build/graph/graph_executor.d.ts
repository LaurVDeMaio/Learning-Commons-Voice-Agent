...
import { UserContext } from '../common/data_types/user_context';
/**
...
export declare class GraphExecutor {
     ...
     * @internal
     */
    constructor(compiledGraph: ExternalReference, executorConfig?: ExternalReference);
    /**
     ...
     */
    execute(data: BaseData, executionId: string): Promise<number>;
    /**
     ...
     * @returns Promise resolving to the execution result
     */
    execute(data: BaseData, executionId: string, userContext: UserContext): Promise<number>;
    /**
     ...
     */
    next(simplified: ExternalReference): Promise<any>;
    /**
