...
import { Graph as GraphExecutor } from '../graph';
import { CustomEdgeConditionReference } from '../nodes/types';
import { AbstractComponent } from './components/AbstractComponent';
import { RemoteEmbedderComponent } from './components/RemoteEmbedderComponent';
import { RemoteLLMComponent } from './components/RemoteLLMComponent';
import { Camelize } from './constants';
import { Component, Node, Subgraph, TextGenerationConfig } from './graph_config_schema';
import { AbstractNode, INTERNAL_COMPONENTS } from './nodes/builtin/AbstractNode';
...
/**
 * Builder class for creating subgraphes with a fluent API.
 * Subgraphes are reusable graph components that can be referenced by other graphs.
 *
 * @example
 * ```typescript
...
export declare class SubgraphBuilder {
     ...
     *
     * @param {Node} node - Node to add to the subgraph
     * @returns {SubgraphBuilder} The builder instance for method chaining
     */
     ...
     *
     * @param {Node|string} fromNode - Source node or node ID
     * @param {Node|string} toNode - Destination node or node ID
    ...
    /**
     * Sets the start node of the subgraph (subgraphes can only have one start node).
     *
     * @param {Node|string} node - Start node or node ID
     * @returns {SubgraphBuilder} The builder instance for method chaining
     */
    setStartNode(node: Node | string | AbstractNode): this;
    /**
     * Sets the end node of the subgraph (subgraphes can only have one end node).
     *
     * @param {Node|string} node - End node or node ID
     * @returns {SubgraphBuilder} The builder instance for method chaining
     */
 ...
 * @property {string} [apiKey] - An optional API key for authentication or authorization purposes.
 * @property {string} [appName] - An optional name of the application utilizing the graph builder.
 * @property {string} [appVersion] - An optional version of the application utilizing the graph builder.
 */
 ...
 * Provides a fluent API for building graphs with nodes, edges, components, and subgraphes.
 *
 * @example
 * ```typescript
...
export declare class GraphBuilder {
    ...
    private apiKey;
    /**
     * Creates a new graph builder with an optional ID.
     ...
     *
     * @param {Subgraph|SubgraphBuilder} subgraph - Subgraph or SubgraphBuilder instance
     ...
     * @param {Object} [parameters.textGenerationConfig] - Text generation configuration
    ...
    /**
     * Adds a node to the graph. Automatically handles LLM component provisioning
     * for LLM nodes that include llmConfig.
     *
     * @param {Node|LLMNode} node - Node to add to the graph
     * @returns {GraphBuilder} The graph instance for method chaining
     */
    addNode(node: Node | AbstractNode): this;
    private addClassNode;
     ...
     *
     * @param {Component} component - Component to add to the graph
     * @returns {GraphBuilder} The graph instance for method chaining
     */
     ...
     *
     * @param {Array<Node|string>} nodes - Array of start nodes or node IDs
     * @returns {GraphBuilder} The graph instance for method chaining
     */
     ...
     *
     * @param {Array<Node|string>} nodes - Array of end nodes or node IDs
     * @returns {GraphBuilder} The graph instance for method chaining
     */
     ...
     *
     * @returns {GraphExecutor} GraphExecutor instance configured with this graph
     */
    build(): GraphExecutor;
}
