...
class LocalLLMConfig {
    ...
    constructor(config) {
        ...
        if (config.defaultConfig) {
            const textConfig = new text_generator_1.TextGenerationConfig(config.defaultConfig);
            expose_binary_1.LocalLLMConfigFunctions.setDefaultConfig(this.getExternal(), textConfig.getExternal());
            textConfig.destroy();
        }
    }
    /**
