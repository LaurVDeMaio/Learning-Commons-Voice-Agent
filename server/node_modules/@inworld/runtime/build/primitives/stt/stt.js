...
class STT {
    ...
    async recognizeSpeech(params) {
        ...
        try {
            ...
            const statusOrRecognizeSpeech = await expose_binary_1.STTInterfaceFunctions.recognizeSpeech(this.stt, audioChunk.getExternal(), speechRecognitionConfig.getExternal());
    ...
    streamIterator(statusOrRecognizeSpeech, inputStream) {
        ...
        return {
            toTextResponse(props) {
                return stringStream.toTextResponse(props);
            },
            toTTSOutputResponse(props) {
                return stringStream.toTTSOutputResponse(props);
            },
            getStream() {
