...
class IntentMatcherConfig {
    ...
    /**
     * Gets the default configuration for embedding-based matching.
     *
     * @returns Default embedding matcher configuration
     */
    static getDefaultEmbeddingConfig() {
        return {
            topNIntents: 3,
            embeddingMatcherConfig: embedding_matcher_config_1.EmbeddingMatcherConfig.getDefaultValues(),
        };
    }
    /**
     * Gets the default configuration for LLM-based matching.
     * Matches the C++ GetDefaultLLMMatcherConfig() implementation.
     *
     * @returns Default LLM matcher configuration
     */
    static getDefaultLLMConfig() {
        return {
            topNIntents: 3,
            llmMatcherConfig: llm_matcher_config_1.LLMMatcherConfig.getDefaultValues(),
        };
    }
    /**
     * Gets the default configuration for compound matching (embedding + LLM).
     *
     * @returns Default compound matcher configuration
     */
    static getDefaultCompoundConfig() {
        return {
            topNIntents: 3,
            embeddingMatcherConfig: embedding_matcher_config_1.EmbeddingMatcherConfig.getDefaultValues(),
            llmMatcherConfig: llm_matcher_config_1.LLMMatcherConfig.getDefaultValues(),
